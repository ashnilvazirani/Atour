    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51GtCLnGNc1zDDy2h72oDu8J6CTqn89ryEvpmk6AqNDo8hlIkErLcAHo2mxR0e87gPMNndjMQH0EexF7Tg4pfsNUi00NNbzPlHi');
            _context.prev = 1;
            _context.next = 4;
            return axios({
              method: 'GET',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Invalid Login credentials');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (res.data.status === 'successfully') {
              setTimeout(function () {
                (0, _alert.showAlert)('success', 'Completed your desired task');
              }, 2000);
              location.reload();
...
var saveBtn = document.querySelector('#saveUserData');
var passwordBtn = document.querySelector('#savePassword');
...
if (loginBtn) {
  loginBtn.addEventListener('click', function (event) {
    ...
    if (!email || !password) {
      return (0, _alert.showAlert)('error', 'Enter both email and password');
    }

    (0, _login.checkLogin)(email, password);
  });
}
...
if (passwordBtn) {
  passwordBtn.addEventListener('click', function (event) {
    var passwwordCurrent = document.getElementById('password-current').value;
    var password = document.getElementById('password').value;
    var confirmPassword = document.getElementById('password-confirm').value;
    event.preventDefault();
    (0, _updateSetting.updateData)({
      passwwordCurrent: passwwordCurrent,
      password: password,
...
if (reviewBtn) {
  reviewBtn.addEventListener('click', function (event) {
    ...
    (0, _updateSetting.updateData)({
      ...
      review: review,
      rating: rating
    }, 'review'); // document.getElementById(`rating-${index}`).value = '';
